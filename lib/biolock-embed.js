class BiolockEmbed {
     ...
     * @param {string} options.page - The BioLock page to display ('upload', 'download', 'create-biolink').
     ...
     * @param {string} [options.background_color] - Background color (hex code string without '#') for the embedded UI.
     ...
     * @param {boolean} [options.display_capture_consent_if_needed=true] - Capture the user’s consent if it has not already been obtained by the parent site.
     * @param {boolean} [options.allow_third_party_cookies=true] - Set to true to enable third-party cookies (default=true); set to false to disable them and suppress the consent popup for these cookies.
     * @param {boolean} [options.display_powered_by_biolock=true] - Set to true to display the "Powered by BioLock" message in the footer of the embedded UI (default=true).
     * @param {boolean} [options.allow_local_dev=false] - Set to true to allow local development and run Biolock service on localhost () (default=false).
     *
     * Options available for upload page
     ...
     * @param {string} [options.displayed_generate_link_button_text] - Customizes the text of the button to generate a link.
     * @param {string} [options.displayed_data_protection_message] - Customizes the "Data Protection" message.
     ...
     * @param {number} [options.video_blur_level=0] - Video blur level (0-100) for the embedded UI.
     *
     * Options available for create Biolink page
    ...
    _buildIframeUrl() {
        ...
        if (this.options.allow_local_dev) {
        ...
        if (this.options.page === 'create-biolink') {
            path = 'create-biolink'
        }
        ...
        for (const key of Object.keys(this.options)) {
            if (!key.startsWith("on") && key !== "document_key") {
    ...
    addJsonToDocument(json) {
        ...
        /**
     * Add JSON to the Biolock iframe.
     * @param {Object} photosFiles - The photos of the sender
     */
