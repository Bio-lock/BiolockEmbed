class BiolockEmbed {
     ...
     * @param {boolean} [options.allow_third_party_cookies] - Set to true to enable third-party cookies (default=true); set to false to disable them and suppress the consent popup for these cookies.
